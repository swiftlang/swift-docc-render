...
describe('TutorialsNavigation', () => {
  ...
  it('renders a TutorialsNavigationList', () => {
    expect(wrapper.findComponent({ name: 'TutorialsNavigation' }).exists()).toBe(true);
  });
  ...
  it('sets the proper active volume on @select-menu', () => {
    wrapper.findComponent({ name: 'TutorialsNavigationMenu' }).vm.$emit('select-menu', 'foobar');
    expect(provide.store.setActiveVolume).toHaveBeenCalledWith('foobar');
  });

  it('deselects the active volume on @deselect-menu', () => {
    wrapper.findComponent({ name: 'TutorialsNavigationMenu' }).vm.$emit('deselect-menu', 'foobar');
